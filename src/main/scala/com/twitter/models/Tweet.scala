...
case class Location(id: Long, name: String, text: String, longitude: List[String], latitude: List[String], capital: List[String])

case class Country(country_code: String, country: String)
